...
static esp_audio_handle_t setup_player()
{
    ...
    i2s_stream_cfg_t i2s_writer = I2S_STREAM_CFG_DEFAULT_WITH_PARA(I2S_NUM_0, 16000, I2S_DATA_BIT_WIDTH_16BIT, AUDIO_STREAM_WRITER);
#else
    // i2s_stream_cfg_t i2s_writer = I2S_STREAM_CFG_DEFAULT_WITH_PARA(I2S_NUM_0, 16000, CODEC_ADC_BITS_PER_SAMPLE, AUDIO_STREAM_WRITER);
