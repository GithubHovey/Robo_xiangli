...
#define MY_BOARD_CONF 1 /*0:demo 1:my PCB*/
/*LCD CONFIG*/
...
#define PIN_NUM_VSYNC          39
#define PIN_NUM_DE             38
#define PIN_NUM_PCLK           15
#define PIN_NUM_DATA0          41 // B1
#define PIN_NUM_DATA1          42 // B2
#define PIN_NUM_DATA2          48 // B3
#define PIN_NUM_DATA3          47 // B4
#define PIN_NUM_DATA4          21 // B5
#define PIN_NUM_DATA5          14 // G0
#define PIN_NUM_DATA6          13 // G1
#define PIN_NUM_DATA7          12 // G2
#define PIN_NUM_DATA8          11 // G3
